...
public class Conversao {
    public static void main(String[] args) {
        ...
        // RA: 2171392511043
        // Objetivo: Faça um programa na Linguagem Java que efetue a apresentação do
        // valor da conversão em real de um valor lido em dólar. O programa deve
        // solicitar o valor da cotação do dólar e também a quantidade de dólares
        // disponível com o usuário, para que seja apresentado o valor em moeda
        // brasileira
